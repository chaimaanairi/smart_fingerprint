...
import { NftMeta, Nft } from "../../../types/nftCourse";
      ...
      <div className="flex-shrink-0">
              ...
              <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-3 mb-3 text-base text-gray-500">{item.meta.description}</p>                  </div>
                </div>
                <div className="overflow-hidden mb-4">
                  <dl className="-mx-4 -mt-4 flex flex-wrap">
                    <div className="flex flex-col px-4 pt-4">
                      <dt className="order-2 text-sm font-medium text-gray-500">Price</dt>
                      <dd className="order-1 text-xl font-extrabold text-green">
                ...
                <div className="text-center">
                  <button
                    ...
                    type="button"
                    className="disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none disabled:cursor-not-allowed mr-2 inline-flex items-center px-20 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-green hover:bg-greenHover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green"
                  >
                    Buy
                  </button>
                </div>
